module.exports = class Transaction{
  constructor(fromAddress, toAddress, doNotSell = false, currentLocation, lastUpdated, timestamp, batchId, growerId, plantsContained, batchWeight, growerLocation, distributorId, itemId, distributorLocation, itemWeight, packaging, retailerId, retailerLocation, regulatorWarnings){
    ...
    this.originTimestamp = timestamp; // grower
    this.batchId = batchId; // grower
    this.growerId = growerId; // grower
    this.plantsContained = plantsContained; // grower
